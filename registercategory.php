...
<div class="form-style-2">
	<div class="form-style-2-heading">Provide information</div>
        ...
        <label for="pro_id"><span>Category ID <span class="required">*</span></span><input type="text" class="input-field" name="cat_id" value="" /></label>
		  	<label for="pro_name"><span>Category Name <span class="required">*</span></span><input type="text" class="input-field" name="cat_name" value="" /></label>
